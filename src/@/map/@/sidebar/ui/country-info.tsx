              ...
              {!pending && hasStatistics && (
                <>
                    ...
                    <li className="info-list__item">
                      ...
                      <div className="average-speed">
                        ...
                        <p className="average-speed__description">
                          The average internet speed is good enough for
                          accessing email and basic internet browsing.
                        </p>
                      </div>
                    </li>
                    <li className="info-list__item">
                  ...
                  <p className="sidebar__paragraph">
                    You can download the country map data by clicking on the
                    button below. File format for the data set would be CSV and
                    PDF.
                  </p>
